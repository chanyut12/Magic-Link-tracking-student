...
const { getAllCases, getAttendanceTasks, reviewCase, getCaseReviews } = require('../controllers/case.controller');
...
router.get('/attendance/tasks', requireAdminApi, getAttendanceTasks);
